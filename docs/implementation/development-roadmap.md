...
- ▶ **M6 — Polish, Price-Integrity & Launch:** next; **not yet detailed**. Live price re-validation, the visual/responsive polish pass, logos/maps. See the [UX & Searchability Plan](../product/25-ux-and-searchability-plan.md).
